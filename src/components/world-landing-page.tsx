...
export default function WorldLandingPage() {
        ...
        request.onsuccess = () => {
          if (request.result) {
            ...
            const defaultMetadata: WorldMetadata = {
              slug: worldSlug,
              name: contextWorldName,
              description: "A new world of adventure awaits...",
            };
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const updatedMetadata: WorldMetadata = {
        slug: worldSlug,
        name: worldName,
      ...
      toast({
        title: "World Updated",
        description: "Your world details have been saved.",
      });
    } catch (e) {
      toast({
        variant: "destructive",
        title: "Error",
        description: "Failed to save world details.",
      });
    }
  };
  ...
  const features = [
    {
      title: "Alchemy",
      description: "Manage potions, powders, oils, and bombs.",
      icon: FlaskConical,
      href: `#/${worldSlug}/alchemy`,
    },
    {
      title: "Bestiary",
    ...
    },
    {
      ...
      icon: BookCopy,
      href: `#/${worldSlug}/deeds`,
    },
    {
      title: "Encounters",
      description: "Design and run combat encounters.",
      icon: Swords,
      href: `#/${worldSlug}/encounters`,
    },
    {
      title: "Items",
      description: "Catalog weapons, armor, and other equipment.",
      icon: Sword,
      href: `#/${worldSlug}/items`,
    },
    {
      title: "NPCs",
    ...
    {
      title: "Factions",
      description: "Manage the various factions in your world.",
      icon: Users,
      href: `#/${worldSlug}/factions`,
    },
    {
      title: "Pantheon",
      description: "Manage the godlike entities of your world.",
      icon: Shield,
      href: `#/${worldSlug}/pantheon`,
    },
    {
      title: "Rooms",
      description: "Build a library of reusable rooms for dungeons.",
      icon: Warehouse,
      href: `#/${worldSlug}/rooms`,
    },
    {
      title: "Treasures",
      description: "Create a library of treasure items.",
      icon: Gem,
      href: `#/${worldSlug}/random/treasures`,
    },
    {
      title: "Encounter Tables",
      description: "Create weighted tables to randomly generate encounters.",
      icon: Dices,
      href: `#/${worldSlug}/random/encounter-tables`,
    },
    {
      title: "Commoners",
      description: "Instantly generate four random commoner PCs.",
      icon: Dices,
      href: `#/${worldSlug}/random/commoners`,
    },
    {
      title: "Dungeons",
      description: "Assemble your pre-defined rooms into complex dungeons.",
      icon: Dices,
      href: `#/${worldSlug}/dungeons`,
    },
    {
      title: "World Map",
    ...
    {
      title: "Calendar",
      description: "A fully-featured in-game calendar.",
      icon: Calendar,
      href: `#/${worldSlug}/calendar`,
    },
